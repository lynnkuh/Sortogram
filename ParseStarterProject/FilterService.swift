...
class FilterService {
    ...
    class func applySepiaEffect(image : UIImage, completion: (filteredImage : UIImage?, name: String) -> Void){
    ...
    class func applyBloomEffect(image : UIImage, completion: (filteredImage : UIImage?, name: String) -> Void){
        let filterName = "CIBloom"
        let displayName = "CIBloom"
